...
public class WheelView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray attribute = context.obtainStyledAttributes(attrs, R.styleable.LW004WheelView);
        unitHeight = (int) attribute.getDimension(R.styleable.LW004WheelView_unitHeight, unitHeight);
        itemNumber = attribute.getInt(R.styleable.LW004WheelView_itemNumber, itemNumber);

        normalFont = attribute.getDimension(R.styleable.LW004WheelView_normalTextSize, normalFont);
        selectedFont = attribute.getDimension(R.styleable.LW004WheelView_selectedTextSize, selectedFont);
        normalColor = attribute.getColor(R.styleable.LW004WheelView_normalTextColor, normalColor);
        selectedColor = attribute.getColor(R.styleable.LW004WheelView_selectedTextColor, selectedColor);

        lineColor = attribute.getColor(R.styleable.LW004WheelView_lineColor, lineColor);
        lineHeight = attribute.getDimension(R.styleable.LW004WheelView_lineHeight, lineHeight);

        selectedBgColor = attribute.getColor(R.styleable.LW004WheelView_selectedBgColor, selectedBgColor);

        maskHeight = attribute.getDimension(R.styleable.LW004WheelView_maskHeight, maskHeight);
        noEmpty = attribute.getBoolean(R.styleable.LW004WheelView_noEmpty, true);
        isEnable = attribute.getBoolean(R.styleable.LW004WheelView_isEnable, true);
