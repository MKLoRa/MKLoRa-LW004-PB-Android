...
import com.moko.lw004.databinding.Lw004DialogPasswordBinding;
import com.moko.lw004.utils.ToastUtils;

public class PasswordDialog extends BaseDialog<Lw004DialogPasswordBinding> {
    ...
    @Override
    protected Lw004DialogPasswordBinding getViewBind() {
        return Lw004DialogPasswordBinding.inflate(getLayoutInflater());
    }
