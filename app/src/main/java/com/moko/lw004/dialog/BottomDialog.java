...
import com.moko.lw004.databinding.Lw004DialogBottomBinding;

import java.util.ArrayList;

public class BottomDialog extends MokoBaseDialog<Lw004DialogBottomBinding> {
    ...
    @Override
    protected Lw004DialogBottomBinding getViewBind(LayoutInflater inflater, ViewGroup container) {
        return Lw004DialogBottomBinding.inflate(inflater, container, false);
    }
