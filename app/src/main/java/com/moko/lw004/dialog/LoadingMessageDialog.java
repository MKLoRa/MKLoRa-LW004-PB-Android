...
import com.moko.lw004.databinding.Lw004DialogLoadingMessageBinding;
import com.moko.lw004.view.ProgressDrawable;

import androidx.annotation.StringRes;
import androidx.core.content.ContextCompat;

public class LoadingMessageDialog extends MokoBaseDialog<Lw004DialogLoadingMessageBinding> {
    ...
    @Override
    protected Lw004DialogLoadingMessageBinding getViewBind(LayoutInflater inflater, ViewGroup container) {
        return Lw004DialogLoadingMessageBinding.inflate(inflater, container, false);
    }
