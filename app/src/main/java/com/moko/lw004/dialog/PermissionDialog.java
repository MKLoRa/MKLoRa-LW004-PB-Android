...
public class PermissionDialog extends RationaleDialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View layoutView = inflater.inflate(R.layout.lw004_dialog_permission, container, false);
    ...
    private void initWindow() {
        if (null != getDialog()) {
            ...
            if (null != window) {
                ...
                window.setBackgroundDrawableResource(R.drawable.lw004_shape_radius_solid_ffffff);
            }
        }
    }
