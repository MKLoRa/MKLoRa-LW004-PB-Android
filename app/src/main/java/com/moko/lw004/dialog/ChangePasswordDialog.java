...
import com.moko.lw004.databinding.Lw004DialogChangePasswordBinding;
import com.moko.lw004.utils.ToastUtils;


public class ChangePasswordDialog extends BaseDialog<Lw004DialogChangePasswordBinding> {
    ...
    @Override
    protected Lw004DialogChangePasswordBinding getViewBind() {
        return Lw004DialogChangePasswordBinding.inflate(getLayoutInflater());
    }
