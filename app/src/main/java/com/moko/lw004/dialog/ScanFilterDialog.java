...
import com.moko.lw004.databinding.Lw004DialogScanFilterBinding;

public class ScanFilterDialog extends BaseDialog<Lw004DialogScanFilterBinding> {
    private int filterRssi;
    private String filterName;

    @Override
    protected Lw004DialogScanFilterBinding getViewBind() {
        return Lw004DialogScanFilterBinding.inflate(getLayoutInflater());
    }
