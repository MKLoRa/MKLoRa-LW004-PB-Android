...
public class AuxiliaryOperationActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LoRaLW004MokoSupport.getInstance().sendOrder(OrderTaskAssembler.getTamperAlarm());
    }
                                ...
                                switch (configKeyEnum) {
                                    case KEY_TAMPER_ALARM:
                                        if (length > 0) {
                                            ...
                                            ivTamperAlarm.setImageResource(mTamperAlarmEnable ? R.drawable.lw004_ic_checked : R.drawable.lw004_ic_unchecked);
                                        }
                                        break;
                                }
                            }
