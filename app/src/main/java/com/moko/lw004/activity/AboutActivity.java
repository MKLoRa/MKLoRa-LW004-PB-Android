...
import com.moko.lw004.databinding.Lw004ActivityAboutBinding;
import com.moko.lw004.utils.Utils;


public class AboutActivity extends BaseActivity {
    private Lw004ActivityAboutBinding mBind;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBind = Lw004ActivityAboutBinding.inflate(getLayoutInflater());
