...
import com.moko.lw004.databinding.Lw004ActivityFilterOtherBinding;
...
public class FilterOtherActivity extends BaseActivity {
    ...
    private Lw004ActivityFilterOtherBinding mBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind = Lw004ActivityFilterOtherBinding.inflate(getLayoutInflater());
                                    ...
                                    case KEY_FILTER_OTHER_RULES:
                                        if (length > 0) {
                                            ...
                                            for (int i = 0, l = filterOther.size(); i < l; i++) {
                                                ...
                                                View v = LayoutInflater.from(this).inflate(R.layout.lw004_item_other_filter, mBind.llFilterCondition, false);
