...
import com.moko.lw004.databinding.Lw004ActivityFilterMkibeaconAccBinding;
...
public class FilterMKIBeaconAccActivity extends BaseActivity {
    ...
    private Lw004ActivityFilterMkibeaconAccBinding mBind;
    private boolean savedParamsError;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBind = Lw004ActivityFilterMkibeaconAccBinding.inflate(getLayoutInflater());
    ...
    private void saveParams() {
        ...
        orderTasks.add(OrderTaskAssembler.setFilterMKIBeaconAccEnable(mBind.cbIbeacon.isChecked() ? 1 : 0));
        LoRaLW004MokoSupport.getInstance().sendOrder(orderTasks.toArray(new OrderTask[]{}));
    }
