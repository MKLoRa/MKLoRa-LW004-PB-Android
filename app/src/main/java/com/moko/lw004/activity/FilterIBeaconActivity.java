...
import com.moko.lw004.databinding.Lw004ActivityFilterIbeaconBinding;
...
public class FilterIBeaconActivity extends BaseActivity {
    ...
    private Lw004ActivityFilterIbeaconBinding mBind;
    private boolean savedParamsError;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBind = Lw004ActivityFilterIbeaconBinding.inflate(getLayoutInflater());
