...
import com.moko.lw004.databinding.Lw004ActivityFilterAdvNameBinding;
...
public class FilterAdvNameActivity extends BaseActivity {
    ...
    private Lw004ActivityFilterAdvNameBinding mBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind = Lw004ActivityFilterAdvNameBinding.inflate(getLayoutInflater());
                                    ...
                                    case KEY_FILTER_NAME_RULES:
                                        if (length > 0) {
                                            ...
                                            for (int i = 0, l = filterAdvName.size(); i < l; i++) {
                                                ...
                                                View v = LayoutInflater.from(FilterAdvNameActivity.this).inflate(R.layout.lw004_item_adv_name_filter, mBind.llDavName, false);
    ...
    public void onAdd(View view) {
        ...
        View v = LayoutInflater.from(this).inflate(R.layout.lw004_item_adv_name_filter, mBind.llDavName, false);
        TextView title = v.findViewById(R.id.tv_adv_name_title);
