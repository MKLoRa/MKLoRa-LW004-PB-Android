...
import com.moko.support.lw004.entity.DataTypeEnum;
...
public class FilterOptionsAActivity extends BaseActivity implements SeekBar.OnSeekBarChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lw004_activity_filter);
                                ...
                                switch (configKeyEnum) {
                                    case KEY_FILTER_SWITCH_A:
                                        if (length == 1) {
                                            ...
                                            ivCondition.setImageResource(filterSwitchEnable ? R.drawable.lw004_ic_checked : R.drawable.lw004_ic_unchecked);
                                        }
                                        break;
                                    case KEY_FILTER_RSSI_A:
                                        if (length == 1) {
                                    ...
                                    case KEY_FILTER_MAC_A:
                                        if (length > 0) {
                                            ...
                                            ivMacAddress.setImageResource(filterMacEnable ? R.drawable.lw004_ic_checked : R.drawable.lw004_ic_unchecked);
                                    ...
                                    case KEY_FILTER_ADV_NAME_A:
                                        if (length > 0) {
                                            ...
                                            ivAdvName.setImageResource(filterNameEnable ? R.drawable.lw004_ic_checked : R.drawable.lw004_ic_unchecked);
                                    ...
                                    case KEY_FILTER_UUID_A:
                                        if (length > 0) {
                                            ...
                                            ivIbeaconUuid.setImageResource(filterUUIDEnable ? R.drawable.lw004_ic_checked : R.drawable.lw004_ic_unchecked);
                                    ...
                                    case KEY_FILTER_MAJOR_RANGE_A:
                                        if (length > 0) {
                                            ...
                                            ivIbeaconMajor.setImageResource(filterMajorEnable ? R.drawable.lw004_ic_checked : R.drawable.lw004_ic_unchecked);
                                    ...
                                    case KEY_FILTER_MINOR_RANGE_A:
                                        if (length > 0) {
                                            ...
                                            ivIbeaconMinor.setImageResource(filterMinorEnable ? R.drawable.lw004_ic_checked : R.drawable.lw004_ic_unchecked);
                                    ...
                                    case KEY_FILTER_ADV_RAW_DATA_A:
                                        if (length > 0) {
                                            ...
                                            ivRawAdvData.setImageResource(filterRawAdvDataEnable ? R.drawable.lw004_ic_checked : R.drawable.lw004_ic_unchecked);
                                            ...
                                            if (length > 1) {
                                                ...
                                                for (int i = 0, l = rawDataBytes.length; i < l; ) {
                                                    View v = LayoutInflater.from(FilterOptionsAActivity.this).inflate(R.layout.lw004_item_raw_data_filter, llRawDataFilter, false);
    ...
    public void onRawDataAdd(View view) {
        ...
        View v = LayoutInflater.from(this).inflate(R.layout.lw004_item_raw_data_filter, llRawDataFilter, false);
        llRawDataFilter.addView(v);
    }
