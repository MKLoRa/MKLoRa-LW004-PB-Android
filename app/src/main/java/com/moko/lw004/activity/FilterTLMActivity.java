...
import com.moko.lw004.databinding.Lw004ActivityFilterTlmBinding;
...
public class FilterTLMActivity extends BaseActivity {
    ...
    private Lw004ActivityFilterTlmBinding mBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind = Lw004ActivityFilterTlmBinding.inflate(getLayoutInflater());
                                ...
                                switch (configKeyEnum) {
                                    ...
                                    case KEY_FILTER_EDDYSTONE_TLM_ENABLE:
                                        if (length > 0) {
                                            ...
                                            mBind.ivTlmEnable.setImageResource(mTLMEnable ? R.drawable.lw004_ic_checked : R.drawable.lw004_ic_unchecked);
                                        }
                                        break;
                                }
                            }
