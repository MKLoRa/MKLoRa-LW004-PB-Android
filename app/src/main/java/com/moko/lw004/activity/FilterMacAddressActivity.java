...
import com.moko.lw004.databinding.Lw004ActivityFilterMacAddressBinding;
...
public class FilterMacAddressActivity extends BaseActivity {
    ...
    private Lw004ActivityFilterMacAddressBinding mBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind = Lw004ActivityFilterMacAddressBinding.inflate(getLayoutInflater());
                                    ...
                                    case KEY_FILTER_MAC_RULES:
                                        if (length > 0) {
                                            ...
                                            for (int i = 0, l = filterMacAddress.size(); i < l; i++) {
                                                ...
                                                View v = LayoutInflater.from(FilterMacAddressActivity.this).inflate(R.layout.lw004_item_mac_address_filter, mBind.llMacAddress, false);
    ...
    public void onAdd(View view) {
        ...
        View v = LayoutInflater.from(this).inflate(R.layout.lw004_item_mac_address_filter, mBind.llMacAddress, false);
        TextView title = v.findViewById(R.id.tv_mac_address_title);
