...
import com.moko.lw004.databinding.Lw004ActivityConnSettingBinding;
import com.moko.lw004.dialog.BottomDialog;
import com.moko.lw004.dialog.LoginDialog;
import com.moko.lw004.dialog.LogoutDialog;
import com.moko.lw004.net.Urls;
import com.moko.lw004.net.entity.CommonResp;
import com.moko.lw004.net.entity.LoginEntity;
...
public class LoRaConnSettingActivity extends BaseActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    private Lw004ActivityConnSettingBinding mBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind = Lw004ActivityConnSettingBinding.inflate(getLayoutInflater());
    ...
    public void onSave(View view) {
        ...
        showSyncingProgressDialog();
        LoRaLW004MokoSupport.getInstance().sendOrder(mOrderTasks.toArray(new OrderTask[]{}));
    }
    ...
    private static final String DEVICE_PROFILE_TYPE = "004_PB_V3";
    private static final String APPLICATION_NAME = "LW004_PB_V3";
    // LW001-BG PRO(L) 10
    // LW001-BG PRO(M) 20
    // LW004-PB 30
    // LW005-MP 40
    ...
    // LW007-PIR 50
    // LW008-MT 60
    private static final String PRODUCT_MODEL = "30";
